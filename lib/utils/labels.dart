...
class Labels {
  ...
  static String monitoringConsent(String v) => switch (v) {
    'not_required' => 'Not required',
    'resident' => 'Resident consent recorded',
    'representative' => 'Representative consent recorded',
    'declined' => 'Declined',
    _ => v,
  };

  static String monitoringMethod(String v) => switch (v) {
    'direct_observation' => 'Direct observation',
    'digital_care_plan' => 'Digital care plan',
    'movement_sensor' => 'Movement sensor',
    'acoustic_monitor' => 'Acoustic monitor',
    'fall_detector' => 'Fall detector',
    'camera' => 'Camera / recording',
    'wearable' => 'Wearable monitor',
    _ => v,
  };
  ...
  static String wellbeingStatus(String v) => switch (v) {
    'stable' => 'Stable',
